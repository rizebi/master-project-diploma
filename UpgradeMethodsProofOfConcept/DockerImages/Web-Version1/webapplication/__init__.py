...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:mypassword@dizertatie-service-db.dizertatie-minikube-24349559-canary-web.svc.cluster.local/webapplication'
